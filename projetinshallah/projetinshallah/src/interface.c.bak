...
create_Ajouter_fatma (void)
{
  ...
  label_ajout = gtk_label_new (_("Ajout"));
  gtk_widget_show (label_ajout);
  gtk_fixed_put (GTK_FIXED (fixeda_fatma), label_ajout, 272, 24);
  gtk_widget_set_size_request (label_ajout, 60, 17);
  ...
  label_municipalite = gtk_label_new (_("Municipalite:"));
  ...
  label5 = gtk_label_new (_("Nombre d'habitants:"));
  ...
  label_statut = gtk_label_new (_("statut des elections:"));
  gtk_widget_show (label_statut);
  gtk_fixed_put (GTK_FIXED (fixeda_fatma), label_statut, 64, 352);
  gtk_widget_set_size_request (label_statut, 140, 17);
  ...
  GLADE_HOOKUP_OBJECT (Ajouter_fatma, label_statut, "label_statut");
